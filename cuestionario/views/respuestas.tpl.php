                         ...
                         <div class=\"col-sm-4\">
                             <div class=\"panel panel-default\">
                                 <div class=\"panel-body\">
                                      <div class=\"alert alert-danger\" role=\"alert\">Porfavor llena el Cuestionario</div>
                                      <br/>
                                 </div>
...
if ($row2 = mysql_fetch_row($consulta5)) {
        ...
        if($calificacion==10){
            ...
            echo "
                    <center><img src='./img/carita.jpg' width='60' height='80' /></center>
        ...
        if($calificacion==9){
            ...
            echo"<h2>Calificación: $calificacion </h2> <br>";
            echo "
                    <center><img src='./img/carita.jpg' width='60' height='60' /></center>
                    <meta http-equiv=\"refresh\" content=\"5;url=cuestionario.net\" />
                    </div>
                     <br/>
                         </div>
        ...
        echo"<h2>Calificación: $calificacion </h2> <br>";
            echo "
<center><img src='./img/carita.jpg' width='130' height='130' /></center>
<meta http-equiv=\"refresh\" content=\"5;url=cuestionario.net\" />
</div>
                                      <br/>
                                 </div>
