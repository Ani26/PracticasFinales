...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">UNIVERSIDAD DE TOLUCA</a>
        </div>
    </div>
</div>
...
<div class='container'>
      ...
      <form class='form-signin' role='form' action='system.php' method='post'>
        <table>
        <tr><td><h2 class='form-signin-heading'>Login</h2></td></tr>
        <tr><td><input type='text' id='usr' name=usr class='form-control' placeholder='Usuario' required autofocus></td></tr>
        <tr><td><input type='password' id='psw' name=psw class='form-control' placeholder='Contraseña' required></td></tr>
